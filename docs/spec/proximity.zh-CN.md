...
<img class="preview-img" align="right" alt="纵向间距示例" description="在 Rubix Design 中，这三种规格分别为：8px（小号间距）、16px（中号间距）、24px（大号间距）。" src="https://os.alipayobjects.com/rmsportal/blBCqHsUJhKxxAU.png">
