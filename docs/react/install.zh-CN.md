...
你可以订阅：https://github.com/rubix-design/rubix-design/releases.atom 来获得稳定版发布的通知。
...
> **历史版本**：https://github.com/rubix-design/rubix-design/releases
...
> 对于 1.0 之前的版本，这里有一个 [自行构建的例子](https://github.com/rubix-design/antd-init/tree/master/examples/build-antd-standalone) 以供参考。

## 开发工具

我们提供了 React 前端应用开发的 [脚手架工具](https://github.com/rubix-design/antd-init)，可以安装到全局直接使用。
...
最新的脚手架结构可以到这里 [查看](https://github.com/rubix-design/antd-init/tree/master/boilerplates)，建议持续关注更新以便获得最新的开发工程特性。

> 更多开发工具 [使用方式](http://rubix-tool.github.io/)。
