  ...
  render() {
    return (
      <div>
        ...
        >
          <SubMenu key="sub1" title={<span><Icon type="mail" /><span>导航 One</span></span>}>
          ...
          <SubMenu key="sub2" title={<span><Icon type="appstore" /><span>导航 Two</span></span>}>
          ...
          <SubMenu key="sub4" title={<span><Icon type="setting" /><span>导航 Three</span></span>}>
