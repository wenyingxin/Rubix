    ...
    return (
      <div>
        <ul className={classSet}>
          <li className="rubix-pwd-strength-item rubix-pwd-strength-item-1" />
          <li className="rubix-pwd-strength-item rubix-pwd-strength-item-2" />
          <li className="rubix-pwd-strength-item rubix-pwd-strength-item-3" />
