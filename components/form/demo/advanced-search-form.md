...
ReactDOM.render(
  <Form horizontal className="rubix-advanced-search-form">
    <Row gutter={16}>
      <Col sm={8}>
        <FormItem
          label="Search name"
...
.rubix-advanced-search-form > .rubix-row {
  position: relative;
  left: -6px;
}

.rubix-advanced-search-form .rubix-btn + .rubix-btn {
  margin-left: 8px;
}
````

<style>
#components-form-demo-advanced-search-form .rubix-form-horizontal {
  max-width: none;
}
</style>
