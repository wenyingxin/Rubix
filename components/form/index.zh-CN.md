...
| prefixCls | 样式类名，默认为 rubix-form，通常您不需要设置 | string | 'rubix-form' |
...
| setFieldsValue | 设置一组输入控件的值（注意：不要在 `componentWillReceiveProps` 内使用，否则会导致死循环，[更多](https://github.com/rubix-design/rubix-design/issues/2985)） | Function({ [fieldName]: value } |
