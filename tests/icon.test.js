...
import rubixicon from '../components/icon/index';
const Icon = wrap(rubixicon);
...
describe('Icon', function() {
  ...
  it('should render to a <i class="xxx"></i>', () => {
    ...
    expect(iconNode.className).toContain('rubixicon');
    expect(iconNode.className).toContain('rubixicon-appstore');
  });
});
