...
If you want to read change logs before `2.0.0`, please visit [GitHub](https://github.com/rubix-design/rubix-design/releases?after=2.0.0).
...
If you meet any problem while you try to upgrade from `antd@1.0.0`, feel free to [create issues on GitHub](https://github.com/rubix-design/rubix-design/issues).

### 2.x Major changes

* Refactor components with TypeScript, and provide **`.d.ts` files which are officially supported**. Thanks to all the developers that contributed to [#1846](https://github.com/rubix-design/rubix-design/issues/1846) and @infeng.
* **Translate the documentation into English**, and we are going to provide both of Chinese and English versions of the documentation in the future. Thanks to all the translators and reviewers that contributed to [#1471](https://github.com/rubix-design/rubix-design/issues/1471).
...
* The `getFieldProps` of Form is replaced with `getFieldDecorator` which will warn developers if they make mistakes. Related discussion [#1533](https://github.com/rubix-design/rubix-design/issues/1533).
...
* Dropdown.Button[disabled] should work. [#3070](https://github.com/rubix-design/rubix-design/issues/3070)
* `option.withRef` of Form.create should work. [#2843](https://github.com/rubix-design/rubix-design/issues/2843)
* Fix slow response of expanding sub menu in Menu[inline] mode. [#2701](https://github.com/rubix-design/rubix-design/issues/2701)
* The button of Modal.confirm(and so on) should not be clickable while it is closed asynchronously. [#2684](https://github.com/rubix-design/rubix-design/issues/2684)
* `format` of DatePicker[showTime] should work. [#3123](https://github.com/rubix-design/rubix-design/issues/3123)
* Fix Table[dataSource] treat key whose value is `0` as inexisting. [#3166](https://github.com/rubix-design/rubix-design/pull/3166) @noonnightstorm
* Tree.Node should not show arrow if it has no child nodes. [#2616](https://github.com/rubix-design/rubix-design/issues/2616)
* Fix cursor style of arrows that are hidden of Tree.Node. [#2748](https://github.com/rubix-design/rubix-design/issues/2748)
...
* Update [font-family](https://github.com/rubix-design/rubix-design/commit/2f308b0f995cfcb2a3c8feb1e35ffd3f0bf93cfc).
...
* Rename `babel-plugin-antd` to [`babel-plugin-import`](https://github.com/rubix-design/babel-plugin-import), and this means that `babel-plugin-import` becomes an common load-on-demand solution and not just for `antd`.
...
Visit [GitHub](https://github.com/rubix-design/rubix-design/releases?after=2.0.0) to read change logs from `0.x` to `1.x`。
