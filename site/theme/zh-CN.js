...
module.exports = {
  ...
  messages: {
    ...
    'app.home.slogan': '农业银行互联网金融前端 UI 设计语言',
    ...
    'app.home.vision': '这是一套致力于提升『用户』和『设计者』使用体验的前台设计语言。',
    'app.footer.repo': '仓库',
    ...
    'app.footer.antd-library': 'Rubix Design 的 Axure 部件库',
