...
declare namespace Antd {
  ...
  */
  ...
  class MonthPicker extends React.Component<MonthPickProps, {}> {
  }
  /**
   * #DatePicker
  输入或选择日期的控件。
  ...
  */
  ...
  /**
  在多数业务情况下，Rubix Design需要在设计区域内解决大量信息收纳的问题，因此在12栅格系统的基础上，我们将整个设计建议区域按照24等分的原则进行划分。
  ...
  */
  ...
  Rubix Design 依次提供了三级选项卡，分别用于不同的场景。
