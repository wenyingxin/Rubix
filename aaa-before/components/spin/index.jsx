...
export default class Spin extends React.Component {
    ...
    render() {
        const [{ className, size, prefixCls, tip, }, restProps] = splitObject(this.props, ['className', 'size', 'prefixCls', 'tip']);
        ...
        if (this.isNestedPattern()) {
            return (<div {...divProps} className={spinning ? (`${prefixCls}-nested-loading`) : ''}>
          {spinElement}
