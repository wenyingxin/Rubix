...
export default class FormItem extends React.Component {
    ...
    renderHelp() {
        ...
        return help ? (<div className={`${prefixCls}-explain`} key="help">
        {help}
      </div>) : null;
    }
    renderExtra() {
        const { prefixCls, extra } = this.props;
        return extra ? (<span className={`${prefixCls}-extra`}>{extra}</span>) : null;
    }
    getValidateStatus() {
    ...
    renderWrapper(children) {
        ...
        return (<Col {...wrapperCol} key="wrapper">
        {children}
      </Col>);
    }
    isRequired() {
    ...
    renderLabel() {
        ...
        return props.label ? (<Col {...labelCol} key="label" className={`${props.prefixCls}-item-label`}>
