...
export default class Tooltip extends React.Component {
    ...
    render() {
        ...
        return (<RcTooltip overlay={title} visible={visible} onPopupAlign={this.onPopupAlign} ref="tooltip" {...this.props} builtinPlacements={this.getPlacements()} onVisibleChange={this.onVisibleChange}>
