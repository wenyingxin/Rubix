...
export default class TimePicker extends React.Component {
    constructor(...args) {
        ...
        this.handleChange = (value) => {
            this.props.onChange(value ? new Date(value.getTime()) : null, value ? this.getFormatter().format(value) : '');
        };
    }
    getFormatter() {
    ...
    render() {
        ...
        return (<RcTimePicker {...props} className={className} locale={locale} formatter={this.getFormatter()} onChange={this.handleChange}/>);
    }
}
