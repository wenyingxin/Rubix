...
export default class Button extends React.Component {
    ...
    render() {
        ...
        const [{ type, shape, size, className, htmlType, children, icon, loading, prefixCls }, others] = splitObject(props, ['type', 'shape', 'size', 'className', 'htmlType', 'children', 'icon', 'loading', 'prefixCls']);
        // large => lg
        // small => sm
        const sizeCls = ({
            large: 'lg',
        ...
        return (<button {...others} type={htmlType || 'button'} className={classes} onMouseUp={this.handleMouseUp} onClick={this.handleClick}>
