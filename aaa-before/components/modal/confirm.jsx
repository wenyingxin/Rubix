...
export default function confirm(config) {
    ...
    let body = (<div className="rubix-confirm-body">
    ...
    let footer = null;
    if (props.okCancel) {
        footer = (<div className="rubix-confirm-btns">
    ...
    ReactDOM.render(<Dialog className={classString} visible closable={false} title="" transitionName="zoom" footer="" maskTransitionName="fade" style={style} width={width}>
