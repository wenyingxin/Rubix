...
export default class Header extends React.Component {
    ...
    getYearSelectElement(year) {
        ...
        return (<Select size={fullscreen ? null : 'small'} dropdownMatchSelectWidth={false} className={`${prefixCls}-year-select`} onChange={this.onYearChange} value={String(year)}>
        {options}
      </Select>);
    }
    getMonthSelectElement(month) {
        ...
        return (<Select size={fullscreen ? null : 'small'} dropdownMatchSelectWidth={false} className={`${prefixCls}-month-select`} value={String(month)} onChange={this.onMonthChange}>
        {options}
      </Select>);
    }
    render() {
