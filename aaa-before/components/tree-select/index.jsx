...
export default class TreeSelect extends React.Component {
    render() {
        ...
        let { size, className, combobox, notFoundContent, prefixCls, } = this.props;
        ...
        return (<RcTreeSelect {...this.props} treeCheckable={checkable} className={cls} notFoundContent={notFoundContent}/>);
    }
}
